...
public class SRSM001 
{
    ...
    /// </summary>
    [Required]
    public char? Upd_Addr { get; set; }
    /// <summary>
    /// 0-平信 1-限時 2-掛號
    /// </summary>
    [Required]
    public char? Mailtype { get; set; }
    /// <summary>
    /// 帳單列印日期
    /// </summary>
    public string Pnt_date { get; set; }
    /// <summary>
    /// 帳單列印人員
    /// </summary>
    public string Pnt_id { get; set; }
    /// <summary>
    /// 資料刪除日期
    /// </summary>
    ...
    public void Copy(SRSM001 src)
    {
        ...
        this.Upd_Addr = src.Upd_Addr;
        this.Mailtype = src.Mailtype;
        this.Pnt_date = src.Pnt_date;
        this.Pnt_id = src.Pnt_id;
        this.Delete_date = src.Delete_date;
        this.Delete_id = src.Delete_id;
        this.Upd_date = src.Upd_date;
        this.Upd_id = src.Upd_id;
        this.Int_Rec = src.Int_Rec;
        this.Cycle = src.Cycle;
    }

    public SRSM001 Clone()
    {
        return new SRSM001 {
            name1 = this.name1,
            name2 = this.name2,
            ...
            Status = this.Status,
            Upd_Addr = this.Upd_Addr,
            Mailtype = this.Mailtype,
            Pnt_date = this.Pnt_date,
            Pnt_id = this.Pnt_id,
